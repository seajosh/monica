<div class="col-xs-12 section-title">
  ...
  <h3>
    ...
    <span>
      <a href="/people/{{ $contact->uiid }}/gifts/add" class="btn">{{ trans('people.gifts_add_gift') }}</a>
    </span>
  </h3>
</div>
...
@if ($contact->getGiftIdeas()->count() == 0 and $contact->getGiftsOffered()->count() == 0)
  ...
  <div class="col-xs-12">
    <div class="section-blank">
      ...
      <a href="/people/{{ $contact->uiid }}/gifts/add">{{ trans('people.gifts_blank_add_gift') }}</a>
    </div>
  </div>
      ...
      <ul class="table">
        ...
        <li class="table-row">
          ...
          <div class="table-cell list-actions">
            <a href="/people/{{ $contact->uiid }}/gifts/{{ $gift->id }}/delete" onclick="return confirm('{{ trans('people.gifts_delete_confirmation') }}')">
