<div class="col-xs-12 section-title">
  ...
  <h3>
    ...
    <span>
      <a href="/people/{{ $contact->uiid }}/tasks/add" class="btn">{{ trans('people.tasks_add_task') }}</a>
    </span>
  </h3>
</div>
...
@if ($contact->getTasksInProgress()->count() === 0 and $contact->getCompletedTasks()->count() === 0)
  ...
  <div class="col-xs-12">
    <div class="section-blank">
      ...
      <a href="/people/{{ $contact->uiid }}/tasks/add">{{ trans('people.tasks_blank_add_activity') }}</a>
    </div>
  </div>
    ...
    <ul class="table">
      ...
      <li class="table-row">
        ...
        <div class="table-cell list-actions">
          <a href="/people/{{ $contact->uiid }}/tasks/{{ $task->id }}/delete" onclick="return confirm('{{ trans('people.tasks_delete_confirmation') }}')">
